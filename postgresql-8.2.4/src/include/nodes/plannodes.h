...
{
	AGG_PLAIN,					/* 0 simple agg across all input rows */
	AGG_SORTED,					/* 1 grouped agg, input must be sorted */
	AGG_HASHED					/* 2 grouped agg, use internal hashtable */
} AggStrategy;
...
typedef struct Agg
{
	...
	int		overlap; /* CHANGED BY RUBY*/
	int		distanceany;
	int 	metric; /* CHANGED BY MINGJIE*/
} Agg;
