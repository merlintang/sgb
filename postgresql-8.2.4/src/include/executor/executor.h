...
/*CHANGED BY YASIN*/
#define EXEC_FLAG_INAROUND		0x0010	/* in around branch*/
...
/*CHANGED BY YASIN*/
extern bool execTuplesMatchAround(TupleTableSlot *pivot1Slot,
...
/*CHANGED BY YASIN*/
extern bool execTuplesMatchAroundHash(TupleTableSlot *pivot1Slot,
				TupleTableSlot *pivot2Slot,
				TupleTableSlot *currentSlot,
...
/*CHANGED BY YASIN*/
extern bool execTuplesMatchAroundHash_MaxR(TupleTableSlot *pivot1Slot,
				TupleTableSlot *pivot2Slot,
				TupleTableSlot *currentSlot,
				AttrNumber aroundOuterAtt,
				int indexInGroupBy,
...
/*CHANGED BY YASIN*/
extern void execTuplesMatchAroundPrepare(TupleDesc tupdesc,
					  int numCols,
					  AttrNumber *matchColIdx,
					  FmgrInfo **eqfunctions,
					  FmgrInfo **ltfunctions,
...
/*CHANGED BY YASIN*/
extern void execTuplesHashPrepareSGB(TupleDesc tupdesc, 
					  int numCols,
					  AttrNumber *matchColIdx,
					  FmgrInfo **eqfunctions,
					  FmgrInfo **hashfunctions,
...
extern TupleHashEntry LookupTupleHashEntry(TupleHashTable hashtable,
					 TupleTableSlot *slot,
					 bool *isnew);
extern TupleHashEntry LookupTupleHashEntry_DIST(AggState *state, TupleHashTable hashtable,
					 TupleTableSlot *slot,
					 bool *isnew); /*CHANGED BY RUBY*/
...
/*extern Relation ExecOpenScanRelationAround(EState *estate, Index scanrelid); CHANGED BY YASIN*/
