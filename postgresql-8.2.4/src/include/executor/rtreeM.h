...
*/
extern int RTreeSearch(HRTREEROOT root, RTREEMBR *mbr, void* pfnSearchCallbackParam, bool iscontain, bool overlaprandom);

/**
* Search in an index tree for all data rectangles that was contained by the input arugument mbr
* Return the number of qualifying data rects.
*/
extern int RTreeSearch_Contain(HRTREEROOT root, RTREEMBR *mbr, void* pfnSearchCallbackParam);
