 ...
 * */
void
op_mergejoin_crossops_SJ(Oid opno, Oid *ltop, Oid *gtop,
					  RegProcedure *ltproc, RegProcedure *gtproc,
					  Oid *loptype, Oid *roptype)/*Changed by Yasin SJ*/
{
	HeapTuple	tp;
	Form_pg_operator optup;
	...
	*ltop = optup->oprltcmpop;
	*gtop = optup->oprgtcmpop;
	*loptype = optup->oprleft; /*Changed by Yasin SJ*/
	*roptype = optup->oprright; /*Changed by Yasin SJ*/
