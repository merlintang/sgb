...
/*nothing here*/
void *
hash_search_DIST(int distanceAll, HTAB *hashp,
			const void *keyPtr,
			HASHACTION action,
			bool *foundPtr)
{
	return hash_search_with_hash_value_DIST(distanceAll, hashp, keyPtr,
			   hashp->hash(keyPtr, hashp->keysize),
			   action,
			   foundPtr);
	/*return hash_search_with_hash_value(hashp,
...
void *
hash_search_with_hash_value_DIST(int distanceall, HTAB *hashp,
							const void *keyPtr,
							uint32 hashvalue,
							HASHACTION action,
							bool *foundPtr)
