...
float *
OutputFunctionCall_Test(FmgrInfo *flinfo, Datum val)
{
	return DatumGetFloat32(FunctionCall1(flinfo, val));
...
float *
OidOutputFunctionCall_Test(Oid functionId, Datum val)
{
	FmgrInfo	flinfo;

	fmgr_info(functionId, &flinfo);

	return OutputFunctionCall_Test (&flinfo, val);
