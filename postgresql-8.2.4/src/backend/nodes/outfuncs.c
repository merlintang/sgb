...
_outAgg(StringInfo str, Agg *node)
{
	...
	/*CHANGED BY YASIN*/
	WRITE_NODE_FIELD(subquery_around_rtable);
	WRITE_INT_FIELD(max_group_diam);
	WRITE_INT_FIELD(max_elem_sep);
	WRITE_INT_FIELD(distanceall); /*CHANGED BY RUBY*/
}
...
_outGroup(StringInfo str, Group *node)
{
	...
	WRITE_INT_FIELD(max_group_diam);
	WRITE_INT_FIELD(max_elem_sep);
	WRITE_INT_FIELD(distAll);/*CHANGED BY RUBY*/
}
...
_outSelectStmt(StringInfo str, SelectStmt *node)
{
	...
	WRITE_NODE_FIELD(larg);
	WRITE_NODE_FIELD(rarg);
	WRITE_NODE_FIELD(aroundSelectStmt); /*CHANGED BY YASIN*/
	WRITE_INT_FIELD(sgb_MaxGroupDiam);  /*CHANGED BY YASIN*/
	WRITE_INT_FIELD(sgb_MaxElemSep);    /*CHANGED BY YASIN*/
	WRITE_INT_FIELD(sgb_distanceAll); /*CHANGED BY RUBY*/
	WRITE_INT_FIELD(sgb_hasOverlap); /*CHANGED BY RUBY*/
	WRITE_INT_FIELD(sgb_distanceAny); /*CHANGED BY RUBY*/
	WRITE_INT_FIELD(sgb_metric);     /*CHANGED BY MINGJIE*/
...
_outQuery(StringInfo str, Query *node)
{
	...
	WRITE_BOOL_FIELD(hasAroundSGB);       /*CHANGED BY YASIN*/
	WRITE_BOOL_FIELD(hasUnsupervisedSGB); /*CHANGED BY YASIN*/
	WRITE_BOOL_FIELD(hasDistAll); /*CHANGED BY RUBY*/
	WRITE_BOOL_FIELD(hasDistAny); /*CHANGED BY RUBY*/
...
_outSortClause(StringInfo str, SortClause *node)
{
	...
	WRITE_OID_FIELD(sortop);
	WRITE_NODE_FIELD(aroundRefPointsSubquery);/*CHANGED BY YASIN*/
	WRITE_INT_FIELD(max_group_diam);    /*CHANGED BY YASIN*/
	WRITE_INT_FIELD(max_elem_sep);      /*CHANGED BY YASIN*/
	WRITE_INT_FIELD(distanceall); /*CHANGED BY RUBY*/
}
...
_outAExpr(StringInfo str, A_Expr *node)
{
	...
	WRITE_INT_FIELD(sj_Type);
	WRITE_INT_FIELD(sj_Epsilon);
	WRITE_INT_FIELD(sj_MaxDiam);
}
