...
_equalQuery(Query *a, Query *b)
{
    ...
    COMPARE_SCALAR_FIELD(hasAroundSGB); /*CHANGED BY YASIN*/
    COMPARE_SCALAR_FIELD(hasUnsupervisedSGB); /*CHANGED BY YASIN*/
    COMPARE_SCALAR_FIELD(hasDistAll); /*CHANGED BY RUBY*/
    COMPARE_SCALAR_FIELD(hasDistAny); /*CHANGED BY RUBY*/
...
_equalSelectStmt(SelectStmt *a, SelectStmt *b)
{
	...
	COMPARE_NODE_FIELD(larg);
	COMPARE_NODE_FIELD(rarg);
	COMPARE_NODE_FIELD(aroundSelectStmt); /*CHANGED BY YASIN*/
	COMPARE_SCALAR_FIELD(sgb_MaxGroupDiam); /*CHANGED BY YASIN*/
	COMPARE_SCALAR_FIELD(sgb_MaxElemSep); /*CHANGED BY YASIN*/
	COMPARE_SCALAR_FIELD(sgb_distanceAll);/*CHANGED BY RUBY */
	COMPARE_SCALAR_FIELD(sgb_hasOverlap);/*CHANGED BY RUBY */
	COMPARE_SCALAR_FIELD(sgb_distanceAny);/*CHANGED BY RUBY */
	COMPARE_SCALAR_FIELD(sgb_metric);/*CHANGED BY RUBY */
...
_equalSortClause(SortClause *a, SortClause *b)
{
	...
	COMPARE_SCALAR_FIELD(sortop);
	COMPARE_NODE_FIELD(aroundRefPointsSubquery); /*CHANGED BY YASIN*/
	COMPARE_SCALAR_FIELD(max_group_diam);  /*CHANGED BY YASIN*/
	COMPARE_SCALAR_FIELD(max_elem_sep);    /*CHANGED BY YASIN*/
	COMPARE_SCALAR_FIELD(distanceall);/*CHANGED BY RUBY */
	COMPARE_SCALAR_FIELD(distanceanyValue);/*CHANGED BY RUBY */
