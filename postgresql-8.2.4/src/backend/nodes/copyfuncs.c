...
_copyGroup(Group *from)
{
	...
	/*CHANGED BY YASIN*/
	COPY_NODE_FIELD(subquery_around_rtable);
	COPY_SCALAR_FIELD(max_group_diam);
	COPY_SCALAR_FIELD(max_elem_sep);
	COPY_SCALAR_FIELD(distAll);/*CHANGED BY RUBY */
...
_copyAgg(Agg *from)
{
	...
	COPY_SCALAR_FIELD(max_group_diam);
	COPY_SCALAR_FIELD(max_elem_sep);
	COPY_SCALAR_FIELD(distanceall);/*CHANGED BY RUBY */
...
_copySortClause(SortClause *from)
{
	...
	COPY_SCALAR_FIELD(sortop);
	COPY_NODE_FIELD(aroundRefPointsSubquery); /*CHANGED BY YASIN*/
	COPY_SCALAR_FIELD(max_group_diam);  /*CHANGED BY YASIN*/
	COPY_SCALAR_FIELD(max_elem_sep);    /*CHANGED BY YASIN*/
	COPY_SCALAR_FIELD(distanceall);/*CHANGED BY RUBY */
...
_copyAExpr(A_Expr *from)
{
	...
	COPY_SCALAR_FIELD(sj_Type);
	COPY_SCALAR_FIELD(sj_Epsilon);
	COPY_SCALAR_FIELD(sj_MaxDiam);
...
_copyQuery(Query *from)
{
	...
	COPY_SCALAR_FIELD(hasAroundSGB);       /*CHANGED BY YASIN*/
	COPY_SCALAR_FIELD(hasUnsupervisedSGB); /*CHANGED BY YASIN*/
	COPY_SCALAR_FIELD(hasDistAll); /*CHANGED BY RUBY*/
	COPY_SCALAR_FIELD(hasDistAny); /*CHANGED BY RUBY*/
	return newnode;
}
...
_copySelectStmt(SelectStmt *from)
{
	...
	COPY_NODE_FIELD(larg);
	COPY_NODE_FIELD(rarg);
	COPY_NODE_FIELD(aroundSelectStmt);   /*CHANGED BY YASIN*/
	COPY_SCALAR_FIELD(sgb_MaxGroupDiam); /*CHANGED BY YASIN*/
	COPY_SCALAR_FIELD(sgb_MaxElemSep);   /*CHANGED BY YASIN*/
