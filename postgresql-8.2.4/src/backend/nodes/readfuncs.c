...
_readQuery(void)
{
	...
	READ_BOOL_FIELD(hasAroundSGB);       /*CHANGED BY YASIN*/
	READ_BOOL_FIELD(hasUnsupervisedSGB); /*CHANGED BY YASIN*/
	READ_BOOL_FIELD(hasDistAll);/*CHANGED BY RUBY*/
	READ_BOOL_FIELD(hasDistAny);/*CHANGED BY RUBY*/
	READ_DONE();
}
...
_readSortClause(void)
{
	...
	READ_NODE_FIELD(aroundRefPointsSubquery); /*CHANGED BY YASIN*/
	READ_INT_FIELD(max_group_diam);     /*CHANGED BY YASIN*/
	READ_INT_FIELD(max_elem_sep);       /*CHANGED BY YASIN*/
	READ_INT_FIELD(distanceall);       /*CHANGED BY RUBY*/
