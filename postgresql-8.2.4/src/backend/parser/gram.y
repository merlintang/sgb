...
%type <node>	stmt schema_stmt
		...
		sgb_aroundSelectStmt_clause   /*CHANGED BY YASIN	*/
...
%type <ival>	add_drop
				sgb_MaxGroupDiam_clause  /*CHANGED BY YASIN	*/
				sgb_MaxElemSep_clause  /*CHANGED BY YASIN	*/

%type <ival>	sgb_DistanceALL_clause /*CHANGED BY RUBY	*/
%type <ival>	sgb_Overlap_clause /*CHANGED BY RUBY	*/
%type <ival>	sgb_DistanceAny_clause /*CHANGED BY RUBY	*/
%type <ival>	sgb_metric_clause /*CHANGED BY RUBY	*/
...
%type <node>	def_arg columnElem where_clause
				a_expr b_expr c_expr func_expr AexprConst sj_expr indirection_el
...
%token <keyword> ABORT_P ABSOLUTE_P ACCESS ACTION ADD_P ADMIN AFTER
	...
	DESC DISABLE_P DISTANCEALL DISTANCEANY /*CHANGE MADE BY RUBY*/
	DISTINCT DO DOMAIN_P DOUBLE_P DROP DUPLICATE /*CHANGE MADE BY RUBY*/
	
	EACH ELIMINATE ELSE ENABLE_P ENCODING ENCRYPTED END_P ESCAPE EXCEPT EXCLUDING /* CHANGE MADE BY RUBY */
	...
	LONE /* CHANGE MADE BY RUBY */
	LTWO
	
	MATCH MAXVALUE 
	METRIC /* CHANGE MADE BY RUBY */
	MINUTE_P MINVALUE MODE MONTH_P MOVE
	MAXELEMSEP    						/* CHANGE MADE BY YASIN */
	MAXGROUPDIAM    					/* CHANGE MADE BY YASIN */
	MAXJOINDIAM							/* CHANGE MADE BY Ahmed.M.Aly */
		
	NAMES NATIONAL NATURAL NCHAR NEW 
	NEW_GROUP /* CHANGE MADE BY RUBY */
	NEXT NO NOCREATEDB
	NOCREATEROLE NOCREATEUSER NOINHERIT NOLOGIN_P NONE NOSUPERUSER
	NOT NOTHING NOTIFY NOTNULL NOWAIT NULL_P NULLIF NUMERIC

	OBJECT_P OF OFF OFFSET OIDS OLD ON ON_OVERLAP ONLY OPERATOR OPTION OR /*CHANGE MADE BY RUBY*/
	...
	WHEN WHERE WITH
	WITHIN					/*CHANGE MADE BY Ahmed.M.Aly*/
	WITHOUT WORK WRITE
...
simple_select:
			...
			group_clause having_clause  
				{
					SelectStmt *n = mErrorakeNode(SelectStmt);
					n->distinctClause = $2;
					n->targetList = $3;
					n->into = $4;
					n->intoColNames = NIL;
			...
			*/
			...
			into_clause from_clause where_clause
			group_clause 
			sgb_aroundSelectStmt_clause sgb_MaxGroupDiam_clause sgb_MaxElemSep_clause /*Currently we support conditions in this order*/
			sgb_DistanceALL_clause /*CHANGED BY RUBY*/
			sgb_Overlap_clause  /*CHANGED BY RUBY*/
			sgb_DistanceAny_clause /*CHANGED BY RUBY*/
			sgb_metric_clause /*CHANGED BY RUBY*/
			having_clause  
				{
					...
					n->aroundSelectStmt = $8;
					n->sgb_MaxGroupDiam = $9;
					n->sgb_MaxElemSep = $10;
					
					n->sgb_distanceAll = $11;
					n->sgb_hasOverlap = $12;
					n->sgb_distanceAny= $13;
					n->sgb_metric = $14;
					n->havingClause = $15;
					$$ = (Node *)n;
				}
...
/* CHANGE MADE BY YASIN */
sgb_aroundSelectStmt_clause:
			AROUND select_with_parens 				{ $$ = $2; }
			| /*EMPTY*/								{ $$ = (Node	   *)NIL; }
		;
		
/* CHANGE MADE BY YASIN */
sgb_MaxGroupDiam_clause:
			MAXGROUPDIAM Iconst 					{ $$ = $2; }
			| /*EMPTY*/								{ $$ = (int) -1; }
		;

/* CHANGE MADE BY YASIN */  
sgb_MaxElemSep_clause:
			MAXELEMSEP Iconst 					{ $$ = $2; }
			| /*EMPTY*/								{ $$ = (int) -1; }
		;
		
/* CHANGE MADE BY RUBY */		
sgb_DistanceALL_clause:
			DISTANCEALL WITHIN Iconst		{ $$ = $3; }
//			| DISTANCEALL WITHIN Iconst ON_OVERLAP DUPLICATE		{ $$ = $3; }
//			| DISTANCEALL WITHIN Iconst ON_OVERLAP ELIMINATE		{ $$ = $3; }
			| /*EMPTY*/								{ $$ = (int) -1; }
		;
		
sgb_Overlap_clause:
ON_OVERLAP ANY {$$= (int) 1;}
| ON_OVERLAP DUPLICATE {$$= (int) 4;}
| ON_OVERLAP ELIMINATE {$$= (int) 3;}
| ON_OVERLAP NEW_GROUP {$$= (int) 2;}
| {$$= (int) -1;}	
;

sgb_DistanceAny_clause:
			DISTANCEANY WITHIN Iconst {$$ = $3;}
			| {$$= (int) -1;}
;
...
where_clause:
			WHERE a_expr							{ $$ = $2; }
			/* CHANGE MADE BY Ahmed.M.Aly */ 
			| WHERE sj_expr							{ $$ = $2; }
			/* END OF CHANGES MADE BY Ahmed.M.Aly */
			| /*EMPTY*/								{ $$ = NULL; }
		;
...
/* CHANGES MADE BY Ahmed.M.Aly for SJ purposes*/
/* The sj_expr appears only in the where clause (in case of similarity join) */ 
sj_expr:	a_expr WITHIN Iconst OF a_expr 
				{ $$ = (Node *) makeSJ_Expr(AEXPR_OP, "=", $1, $5, $3, 0); }
			| a_expr AROUND a_expr MAXJOINDIAM Iconst
				{ $$ = (Node *) makeSJ_Expr(AEXPR_OP, "=", $1, $3, 0, $5); }
			| a_expr AROUND a_expr
				{ $$ = (Node *) makeSJ_Expr(AEXPR_OP, "=", $1, $3, 0, 0); }
