...
#include "nodes/print.h" /*CHANGED BY YASIN*/
...
transformSelectStmt(ParseState *pstate, SelectStmt *stmt)
{
	...
	qry->groupClause = transformGroupClause(pstate,
											...
											&qry->targetList,
											qry->sortClause,
											(Node *)stmt->aroundSelectStmt,    /*CHANGED BY YASIN*/
											(bool *)&qry->hasAroundSGB,        /*CHANGED BY YASIN*/
											(bool *)&qry->hasUnsupervisedSGB,  /*CHANGED BY YASIN*/
											stmt->sgb_MaxGroupDiam,            /*CHANGED BY YASIN*/
											stmt->sgb_MaxElemSep,			   /*CHANGED BY YASIN*/
											(bool *)&qry->hasDistAll,			/*CHANGED BY RUBY*/
											stmt->sgb_distanceAll,				/*CHANGED BY RUBY*/
											stmt->sgb_hasOverlap,				/*CHANGED BY RUBY*/
											stmt->sgb_distanceAny,
											(bool *)&qry->hasDistAny,
											stmt->sgb_metric);            /*CHANGED BY RUBY*/
	...
	{
		A_Expr	   *a = (A_Expr *) stmt->whereClause;
		qry->jointree->SJ_Type = a->sj_Type;
		qry->jointree->epsilon = a->sj_Epsilon;
		qry->jointree->max_diameter = a->sj_MaxDiam;
	}
