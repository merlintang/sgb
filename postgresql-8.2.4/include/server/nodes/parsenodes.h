...
typedef struct Query
{
	...
	bool		hasAggs;		/* has aggregates in targetlist or havingQual */
    ...
    /*CHANGED BY YASIN*/
	bool		hasAroundSGB;	/* has aroud block*/
	bool		hasUnsupervisedSGB;	/* has unsupervised SGB block*/

	/*CHANGED BY RUBY*/
	bool		hasDistAll; /* has Distance-ALL SGB block*/
	bool        hasDistAny;
...
typedef struct A_Expr
{
	...
	/* CHANGED BY Ahmed.M.Aly for SJ purposes */
	int sj_Type;				// The type of the SJ (WITHIN or AROUND)
	int sj_Epsilon;				// The value of epsilon for epsilon join
	int sj_MaxDiam;				// The value of max_diameter for around join
} A_Expr;
...
typedef struct SortClause
{
	...
	/*CHANGED BY YASIN*/
	Node		*aroundRefPointsSubquery; /*the subquery of the reference points for grouping this col using SGB-around. Used ONLY in GroupClause*/
	int		max_group_diam; /*maximum group diameter*/
	int		max_elem_sep; /*maximum element separation*/
	int		distanceall; /* CHANGED BY RUBY*/
	int		overlapValue;/* CHANGED BY RUBY*/
	int		distanceanyValue;/* CHANGED BY RUBY*/
	int		metricValue;/* CHANGED BY RUBY*/
...
typedef struct SelectStmt
{
	...
	/*CHANGED BY YASIN*/
	Node	   *aroundSelectStmt;
    int        sgb_MaxGroupDiam;
    int        sgb_MaxElemSep;

    int        sgb_distanceAll; /*CHANGED BY RUBY*/
    int		   sgb_hasOverlap;/*CHANGED BY RUBY	*/
    int		   sgb_distanceAny;/*CHANGED BY RUBY	*/
    int		   sgb_metric;/*CHANGED BY RUBY	*/
