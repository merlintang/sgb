...
typedef struct HASHELEMENT
{
	...
	int left; /*CHANGED BY RUBY*/
	int right; /*CHANGED BY RUBY*/
...
extern void *hash_search(HTAB *hashp, const void *keyPtr, HASHACTION action,
			bool *foundPtr);
extern void *hash_search_DIST(int distanceAll, HTAB *hashp, const void *keyPtr, HASHACTION action,
			bool *foundPtr); /*CHANGED BY RUBY */
...
extern void *hash_search_with_hash_value_DIST(int distanceall, HTAB *hashp, const void *keyPtr,
							uint32 hashvalue, HASHACTION action,
							bool *foundPtr);/* CHANGED BY RUBY */
